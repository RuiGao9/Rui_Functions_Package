...
def Footprint_Digital_Results(footprint, tseb_r_1, tseb_r_2, temp_image, dir_out, 
    ...
    if single_layer_temp == "Yes":
        ...
        print("Soil longwave radiation:",round(out_ln_s,3))
        print("Canopy longwave radiation:",round(out_ln_c,3))
        print("Soil shortwave radiation:",round(out_sn_s,3))
        print("Canopy shortwave radiation:",round(out_sn_c,3))
        print("\nLAI:",round(out_lai,3))
